...
var gameOfThronesHouses = [
  ...
  //console.log(gameOfThronesHouses);
  console.log("Get the first houses name: " + gameOfThronesHouses[0].name);
  console.log("Get the Lannister houses wikiSuffix: " + gameOfThronesHouses[1].wikiSuffix);
  console.log("Get the name Catelyn (Tully) Stark: " + gameOfThronesHouses[6].people[0].name);
  console.log("Get the fourth houses, second persons description: " + gameOfThronesHouses[3].people[1].description);



  //var result = objArray.map(function(a) {return a.foo;});
  var houseNames = gameOfThronesHouses.map(function(element) {return element.name;}).join(', ');
  console.log("Get a list of all the houses names: " + houseNames);
  console.log("*************************************************************");
  console.log("*************************************************************");
  console.log("*************************************************************");


  var houseList = gameOfThronesHouses.map(function(element) {return element.people.map(function(subel) { return subel.name})});
  houseList.join(" ").split(" ").join(", ");
  console.log("Get a list of all the peoples names: " + houseList);


  //var peopleNames = houseList.map(function(people) {return people.name;}).join(', ');
  //console.log("*************************************************************");
  //var test = gameOfThronesHouses.people.map(function(person) {return person.name;});
  //console.log(test);
  //console.log(peopleNames);
  //console.log("Get a list of all the peoples names: " + peopleNames);
